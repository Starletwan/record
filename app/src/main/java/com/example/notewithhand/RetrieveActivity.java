...
public class RetrieveActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final MYSQLiteOpenHelper dbHelper = new MYSQLiteOpenHelper(this,"Record.db",null,1);
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                RetrieveActivity.this,android.R.layout.simple_list_item_1,list);
        ...
        btnsearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(RetrieveActivity.this,"ok",
        ...
        btnback.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent1=new Intent(RetrieveActivity.this,MainActivity.class);
